...
$('#title').click(function(e) {
  ...
  e.preventDefault();
  _trackEvent('Plus', 'Logo', 'Click on the logo');
});
$('#enable').click(function() {
  $('#presentation').fadeOut('normal', function() {
    $('#code_howto').fadeIn();
  });
  _trackEvent('Wizard', 'Enable', 'Click on the "Enable tumblrbox" button');
});
$('#code').click(function() {
  $(this).focus().select();
  _trackEvent('Wizard', 'Code', 'Click on the code area');
});
$('#done').click(function() {
  $('#code_howto').fadeOut('normal', function() {
    $('#further').fadeIn();
  });
  _trackEvent('Wizard', 'Done', 'Click on the "Im \'done" button');
});
$('#bookmarklet').click(function(e) {
  ...
  e.preventDefault();
  _trackEvent('Plus', 'Bookmarklet', 'Click on the bookmarklet link');
});
$('#picuous').click(function() {
  _trackEvent('Wizard', 'Picuous', 'Click on the Picuous button');
});
